...
plot \"$trapfile\" using 1:4 ls 1 title \"Trapezoid Method\"
set output \"$datdir/convergence_montecarlo.png\"
set title \"Convergence Test - Monte Carlo Method\"
plot \"$montecarlofile\" using 1:4 ls 2 title \"Monte Carlo Method\"
set title \"Monte Carlo Method - Standard Deviation\"
set output \"$datdir/standdev_montecarlo.png\"
plot \"$montecarlofile\" using 1:3 ls 2 title \"Standard Deviation for $num_stats runs\"
"
